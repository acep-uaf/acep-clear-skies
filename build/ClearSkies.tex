...
of remote communities unconnected to any central grid.
...
\emph{local-first, cloud-free cyberinfrastructure model} designed
specifically for Alaska's rural and tribal energy communities.\\
...
cybersecurity, and data management---to operate \textbf{independently of
the cloud}, even during extended Internet outages.
...
of digital sovereignty}, extending the principles of local and tribal
...
keep the lights on---but to illuminate their own path toward
independence, innovation, and long-term sustainability in the digital
era.
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.6701}}@{}}
\toprule
\begin{minipage}[b]{\linewidth}\raggedright
Acronym
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
