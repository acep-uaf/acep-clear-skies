...
--- operates independently of the the Internet and cloud services,
ensuring that essential services remain available, secure, and under
local control even when Internet connectivity is lost.

Clear Skies adopts a strategic \textbf{layered} approach to build
increasingly complex \textbf{modular} capabilities on top of a resilient
...
\hypertarget{pve-node}{%
\paragraph{PVE Node}\label{pve-node}}
...
\begin{figure}
\centering
\includegraphics{lib/diag/ClearSkies-SDDC-PVE-Node.300x.png}
\caption{SCCD PVE Node}
\end{figure}

\hypertarget{pve-hyper-converged-cluster}{%
\paragraph{PVE Hyper-Converged
Cluster}\label{pve-hyper-converged-cluster}}

A Hyper-Converged ProxMox
Cluster(\protect\hyperlink{ref-DeployHyperConvergedCeph}{{``Deploy
{Hyper-Converged Ceph Cluster} - {Proxmox VE}''} n.d.}) is comprised of
fully redundant hardware systems in triplicate (or more N+1) nodes
abstracting CPU, RAM, DISK, and NET hardware from the vitalized systems
running on the cluster.

\begin{figure}
\centering
\includegraphics{lib/diag/ClearSkies-SDDC-PVE-Cluster.png}
\caption{SDDC PVE Cluster}
\end{figure}
...
ASRock Jupiter X600 (35W) & AMD Ryzen 9000/8000/7000 Series (AM5) (--C)
& 96 & M.2 2280 NVMe SSD 0 TB & SATA 2.5-inch HDD/SSD x1 0 TB & 2 & 0 &
1U (approx.) & -- & -- \\
\bottomrule
\end{longtable}
...
\hypertarget{asrock-jupiter-x600-35w}{%
\subsubsection{ASRock Jupiter X600
(35W)}\label{asrock-jupiter-x600-35w}}

\begin{figure}
\centering
\includegraphics{lib/img/ASRock_Jupiter-X600.jpg}
\caption{ASRock Jupiter X600 (35W)}
\end{figure}
...
Supported OS & Windows 10 64-bit, Windows 11 64-bit, Linux (Ubuntu
compatible) \\
Price (USD) & \$-- \\
Product Page &
\href{https://www.asrock.com/nettop/AMD/Jupiter\%20X600/index.us.asp}{Link} \\
\bottomrule
\end{longtable}
...
\leavevmode\vadjust pre{\hypertarget{ref-DeployHyperConvergedCeph}{}}%
{``Deploy {Hyper-Converged Ceph Cluster} - {Proxmox VE}.''} n.d.
https://pve.proxmox.com/wiki/Deploy\_Hyper-Converged\_Ceph\_Cluster.
